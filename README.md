# Auto Export System
<img width="539" height="339" alt="image" src="https://github.com/user-attachments/assets/dd89b373-64fc-4a72-b366-203b7b7830e0" />
...
1. Backup ไฟล์เดิมเข้า folder วันที่ของวันก่อนหน้า
2. Clear hourly files
3. สร้างไฟล์ใหม่ 00-23.xlsx

ตัวอย่างเมื่อระบบ reset วันที่ 2026-05-18 เวลา 12:00 PM ไฟล์เดิมจะถูกเก็บใน folder ของวันที่ 2026-05-17:
